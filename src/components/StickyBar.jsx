...
export default function StickyBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 grid grid-cols-3 gap-px bg-neutral-200 md:hidden">
      <a
        href={PHONE_URL}
        className="flex flex-col items-center gap-1 bg-white py-3 text-center text-xs font-semibold text-[#111827] transition-colors duration-200 active:bg-neutral-50 hover:bg-neutral-50"
      >
        <svg
          className="h-5 w-5"
          fill="none"
